...
<html lang="en">
  <head>
    ...
    <style>
      ...
      body {
        background-image: linear-gradient(to right, darkorange, red, purple); 
      }
    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <p class="lead text-white">Website ini bisa mempermudah proses audit pinjam meminjam buku</p>
                <p>
